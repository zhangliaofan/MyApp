...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/../my_flutter/.ios/Flutter/engine/Flutter.xcframework" "" "true" "ios-armv7_arm64/Flutter.framework" "ios-x86_64-simulator/Flutter.framework"
fi
